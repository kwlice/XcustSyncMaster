...
{
    public class XCustApSourceWebService : Form
    {
        int gapLine = 5;
        ...
        public XCustApSourceWebService(ControlMain cm)
        {
        ...
        private void initConfig()
        {
            ...
            lb2.Text = lb2.Text + " " + Cm.xcustAPSourcewebservice_run;
            if (Cm.xcustAPSourcewebservice_run.ToLower().Equals("on"))
            {
        ...
        private void initCompoment()
        {
            ...
            lb2.Font = cApWS.fV1;
            lb2.Text = "Program Name Xcust Ap Source Master Webservice";
            lb2.AutoSize = true;
            Controls.Add(lb2);
